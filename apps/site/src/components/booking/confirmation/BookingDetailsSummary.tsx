...
import { formatDate, formatTime, getTypeLabel } from "@/utils/booking-helpers";
  ...
  return (
    <div className="booking-card mb-3">
      ...
      <div className="summary-row mb-2">
        ...
        <div className="summary-value">
          <i className="bi bi-calendar me-2 text-success" style={{ fontSize: "0.875rem" }}></i>
      ...
      <div className="summary-row mb-2">
        ...
        <div className="summary-value">
          <i className="bi bi-clock me-2 text-success" style={{ fontSize: "0.875rem" }}></i>
      ...
      <div className="summary-row mb-2">
        ...
        <div className="summary-value">
          <i className="bi bi-people me-2 text-success" style={{ fontSize: "0.875rem" }}></i>
      ...
      {booking.additionalServices && booking.additionalServices.length > 0 && (
        <>
          ...
          <div className="mb-2">
            <h6 className="mb-2 d-flex align-items-center gap-2" style={{ fontSize: "0.875rem" }}>
              <i className="bi bi-bag-plus text-success" style={{ fontSize: "0.875rem" }}></i>
              Services supplémentaires
            </h6>
            {booking.additionalServices.map((service, index) => (
              <div key={index} className="summary-row mb-1">
                <div className="summary-label" style={{ fontSize: "0.8125rem" }}>
            ...
            <div className="summary-row mt-2 pt-2" style={{ borderTop: "1px solid hsl(var(--border))" }}>
              <div className="summary-label" style={{ fontWeight: "600", fontSize: "0.8125rem" }}>
                Sous-total services
              </div>
              <div className="summary-value" style={{ fontWeight: "600", fontSize: "0.8125rem" }}>
      ...
      <div className="summary-row">
        ...
        <div className="summary-value">
          <h4 className="text-success mb-0" style={{ fontSize: "1.25rem", fontWeight: "700" }}>
