...
const DefaultStarRating = () => {
  ...
  return (
    <ComponentContainerCard
      title="Basic @smastrom/react-rating Example"
      id="basic"
      titleClass="mb-3"
    >
...
const HighlightOnlyRating = () => {
  ...
  return (
    <ComponentContainerCard
      title="Highlight only selected Example"
      id="highlight"
      titleClass="mb-3"
    >
      <Rating
...
const ResetButtonRating = () => {
  ...
  return (
    <ComponentContainerCard
      title="Rating With Reset Button"
      id="reset_example"
      titleClass="mb-3"
    >
