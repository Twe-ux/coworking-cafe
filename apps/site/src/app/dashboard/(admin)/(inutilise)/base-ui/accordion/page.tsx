  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          Using the card component, you can extend the default collapse behavior
          to create an accordion. To properly achieve the accordion style, be
      ...
      <Accordion defaultActiveKey={"0"} id="accordionExample">
        {accordionData.map((item, idx) => (
          <AccordionItem eventKey={`${idx}`} key={idx}>
            ...
            <AccordionBody>
              <strong>
                This is the {item}&nbsp; item&apos;s accordion body.
              </strong>
        ...
        {accordionData.map((item, idx) => (
          <AccordionItem eventKey={`${idx}`} key={idx}>
            ...
            <AccordionBody>
              ...
              demonstrate the
              <code>.accordion-flush</code>&nbsp; class. This is the {item}
