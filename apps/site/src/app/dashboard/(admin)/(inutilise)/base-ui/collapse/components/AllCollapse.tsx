  ...
  return (
    ...
    >
      ...
      <p className="text-muted">
        ...
        <code>data-bs-target</code> attribute. While not recommended from a
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          the&nbsp; <code>width</code> instead of&nbsp; <code>height</code> and
          set a&nbsp; <code>width</code> on the immediate child element. Feel
          free to write your own custom Sass, use inline styles, or use our
          width utilities.
        </>
      }
    >
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          hide an element if they each reference it with their <code>href</code>{" "}
