...
import logoLight from "@/assets/dashboard/images/logo-light.png";
...
const BasicToast = () => {
  ...
  return (
    ...
    >
      <Toast
        className="fade d-block opacity-100"
        role="alert"
        onClose={hide}
        show={!isOpen}
      >
...
const LiveExample = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Click the button below to show a toast (positioned with our utilities
          in the lower right corner) that has been hidden by default.
        </>
      }
    >
      <Button
  ...
  return (
    ...
    >
      <Row>
        <Col md={6}>
          <Toast
            className="align-items-center mb-3 fade"
            show={isOpenCustom1}
            onClose={hideCustom1}
            delay={3000}
            autohide
        ...
        <Col md={6}>
          <Toast
            className="align-items-center text-white bg-primary mb-3"
            show={isOpenCustom2}
            onClose={hideCustom2}
            delay={6000}
            autohide
      ...
      <Row>
        ...
        <Col md={6}>
          <Toast
            className="text-bg-primary fade"
            show={isOpenCustom4}
            onClose={hideCustom4}
            delay={10000}
            autohide
...
const TranslucentToast = () => {
  const { isTrue: isOpenTranslucent, toggle: hideTranslucent } =
    useToggle(true);
      ...
      <Form>
        <div className="mt-3">
          ...
          <ReactSelect
            className="mt-2"
            onChange={(e) =>
              setPosition(e?.value as ToastContainerProps["position"])
            }
            options={[
