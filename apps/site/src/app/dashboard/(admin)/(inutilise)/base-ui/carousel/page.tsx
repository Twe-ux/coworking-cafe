...
import Img10 from "@/assets/dashboard/images/small/img-10.jpg";
import Img2 from "@/assets/dashboard/images/small/img-2.jpg";
import Img3 from "@/assets/dashboard/images/small/img-3.jpg";
import Img4 from "@/assets/dashboard/images/small/img-4.jpg";
import Img5 from "@/assets/dashboard/images/small/img-5.jpg";
import Img6 from "@/assets/dashboard/images/small/img-6.jpg";
import Img7 from "@/assets/dashboard/images/small/img-7.jpg";
import Img8 from "@/assets/dashboard/images/small/img-8.jpg";
import Img9 from "@/assets/dashboard/images/small/img-9.jpg";
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          them initially with <code>.d-none</code> and bring them back on
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          with a fade transition instead of a slide. Depending on your carousel
...
const IndividualInterval = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Add <code>data-bs-interval=&ldquo;</code> to a{" "}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          includethe <code>data-bs-ride</code> attribute so it doesn’t autoplay.
        </>
      }
    >
      {/* <Row> */}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          darker controls, indicators, and captions. Controls have been inverted
          from their default white fill with the<code>filter</code> CSS
          property. Captions and controls have additional Sass variables that
