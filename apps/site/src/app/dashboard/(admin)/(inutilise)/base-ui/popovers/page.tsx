  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          We use JavaScript similar to the snippet above to render the following
          live popover. Titles are set via <code>data-bs-title</code> and body
...
const HoverPopover = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Use the <code>data-bs-trigger=&quot;hover&quot;</code> trigger Hover
          to show popover.
        </>
      }
    >
...
const CustomPopovers = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          ou can customize the appearance of popovers using CSS variables. We
          set a custom class with{" "}
          <code>data-bs-custom-class=&quot;primary-popover&quot;</code> to scope
          our custom appearance and use it to override some of the local CSS
          variables.
        </>
      }
    >
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          tooltip). As a workaround, you’ll want to trigger the popover from a
