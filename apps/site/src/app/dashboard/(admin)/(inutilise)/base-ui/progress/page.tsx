  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          We only set a height value on the <code>.progress</code>, so if you
          change that value the inner <code>.progress-bar</code> will
          automatically resize accordingly. Use <code>.progress-xs</code>,{" "}
          <code>.progress-sm</code>, <code>.progress-md</code>,{" "}
