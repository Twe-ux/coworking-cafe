...
const TooltipDirections = () => {
  const directions: OverlayProps["placement"][] = [
    "top",
    "right",
    "bottom",
    "left",
    ...
    >
      <div className="d-flex flex-wrap gap-3">
        {directions.map((direction, idx) => (
          <OverlayTrigger
            placement={direction}
            overlay={<Tooltip>Tooltip on {direction}</Tooltip>}
            key={idx}
          >
            <Button
              variant="primary"
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          our background-color primary appearance and use it to override a local
          CSS variable.
        </>
      }
    >
