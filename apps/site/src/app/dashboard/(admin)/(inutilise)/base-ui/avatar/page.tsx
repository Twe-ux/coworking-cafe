...
import avatar3 from "@/assets/dashboard/images/users/avatar-3.jpg";
import avatar4 from "@/assets/dashboard/images/users/avatar-4.jpg";
import avatar5 from "@/assets/dashboard/images/users/avatar-5.jpg";
...
import avatar9 from "@/assets/dashboard/images/users/avatar-9.jpg";
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          classes. Using Bootstrap&apos;s naming convention, you can control
          size of avatar including standard avatar, or scale it up to different
          sizes.
        </>
      }
    >
