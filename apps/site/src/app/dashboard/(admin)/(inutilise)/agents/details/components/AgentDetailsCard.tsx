      ...
      <div className="mt-3 d-flex flex-wrap gap-2">
        {propertyFileData.map((item, idx) => (
          ...
          >
            <IconifyIcon
              icon={item.icon}
              className={`text-${item.variant} fs-24`}
            />
            <div>
    ...
    <Card>
      <CardBody>
        ...
        <div className="mt-4">
          ...
          <p className="mb-2">
            Meet Michael, a dedicated and experienced real estate agent who is
            committed to making your real estate journey smooth and successful.
            With a passion for helping clients achieve their dreams, Michael
            brings a wealth of knowledge and expertise to every transaction.
          </p>
          <p className="mb-2">
            Michael has been a prominent figure in the real estate industry for
            over a decade. His career began with a focus on residential
            properties, quickly expanding to include commercial real estate and
            investment properties. Michael&apos;s extensive experience and deep
            understanding of the market allow him to navigate even the most
