...
const BrowserDefault = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Depending on your browser and OS, you’ll see a slightly different
          style of feedback.
        </>
      }
    >
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          JavaScript. When attempting to submit, you’ll see the{" "}
          <code>:invalid</code> and <code>:valid</code> styles applied to your
          form controls.
        </>
      }
    >
...
const ServerSideValidation = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    event.stopPropagation();
    setValidated(true);
    const validationReply = (await serverSideFormValidate(
      formValue
    )) as ValidationError;
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          classes to display validation feedbackin a styled tooltip. Be sure to
