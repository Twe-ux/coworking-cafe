...
const CopyFromElement = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          The value you include on this attribute needs to match another&apos;s
          element selector.
        </>
      }
    >
...
const CutFromElement = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Additionally, you can define a <code>data-clipboard-action</code>{" "}
          attribute to specify if you want to either <code>copy</code> or{" "}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          from. You can just include a <code>data-clipboard-text</code>{" "}
