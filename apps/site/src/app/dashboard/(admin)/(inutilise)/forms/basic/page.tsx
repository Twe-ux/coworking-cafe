    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          a grayed out appearance, remove pointer events, and prevent focusing.
        </>
      }
    >
      <Row>
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          modification of the input’s value. <code>readonly</code> inputs can
          still be focused and selected, while <code>disabled</code> inputs
          cannot.
          <br />
          <br />
          If you want to have <code>&lt;input readonly&gt;</code> elements in
          your form styled as plain text, replace <code>.form-control</code>{" "}
          with <code>.form-control-plaintext</code> to remove the default form
          field styling and preserve the correct <code>margin</code> and{" "}
          <code>padding</code>.
        </>
      }
    >
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <code>.form-select</code> to trigger the custom styles. Custom styles
          are limited to the <code>&lt;select&gt;</code>’s initial appearance
          and cannot modify the <code>&lt;option&gt;</code>s due to browser
          limitations.
        </>
      }
    >
