"use client";
import mastercard from "@/assets/dashboard/images/card/mastercard.svg";
import chip from "@/assets/dashboard/images/chip.png";
import contactlessImg from "@/assets/dashboard/images/contactless-payment.png";
import avatar1 from "@/assets/dashboard/images/users/avatar-2.jpg";
                              ...
                              <div className="position-relative">
                                ...
                                <span className="position-absolute bottom-0 end-0  rounded-circle">
                                  <span>
                                    <IconifyIcon
                                      icon="ri:circle-fill"
                                      className={`fs-10 align-bottom text-${
