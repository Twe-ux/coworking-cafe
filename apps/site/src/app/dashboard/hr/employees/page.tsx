...
export default function EmployeesPage() {
  ...
  const [endContractReason, setEndContractReason] = useState<
    "démission" | "fin-periode-essai" | "rupture" | ""
  >("");
  ...
  useEffect(() => {
    ...
    setPageActions(
      <div style={{ display: "flex", gap: "8px" }}>
        ...
        >
          <Icon
            icon={showArchived ? "ri:eye-off-line" : "ri:archive-line"}
            width={16}
          />
  ...
  const handleCreateEmployee = async () => {
    try {
      ...
      if (!/^\d{15}$/.test(newEmployee.socialSecurityNumber)) {
        setMessage({
          type: "error",
          text: "Le numéro de sécurité sociale doit contenir 15 chiffres",
        });
        return;
      }
      ...
      if (!/^\d{4}$/.test(newEmployee.clockingCode)) {
        setMessage({
          type: "error",
          text: "Le code de pointage doit contenir 4 chiffres",
        });
        return;
      }
  ...
  const handleEditEmployee = async (employee: Employee) => {
    try {
      ...
      if (data.success) {
        ...
        const employeeData = {
          ...
          hireDate: data.data.hireDate
            ? new Date(data.data.hireDate).toISOString().split("T")[0]
            : "",
        };
      ...
      setMessage({
        type: "error",
        text: "Erreur lors du chargement de l'employé",
      });
    }
  };
  ...
  const handleUpdateEmployee = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/hr/employees/${selectedEmployee._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleResignEmployee = async () => {
    ...
    if (!endContractDate) {
      setMessage({
        type: "error",
        text: "Veuillez saisir une date de fin de contrat",
      });
      return;
    }
    ...
    if (!endContractReason) {
      setMessage({
        type: "error",
        text: "Veuillez sélectionner un motif de fin de contrat",
      });
      return;
    }
    ...
    try {
      ...
      if (endDate > today) {
        ...
        if (response.ok) {
          setMessage({
            type: "success",
            text: `Date de fin de contrat enregistrée (${endDate.toLocaleDateString(
              "fr-FR"
            )}). L'employé sera automatiquement archivé à cette date.`,
          });
        ...
        if (deleteResponse.ok) {
          setMessage({
            type: "success",
            text: "Employé archivé (fin de contrat)",
          });
          setShowResignModal(false);
          setSelectedEmployee(null);
          setEndContractDate("");
  ...
  const updateAvailability = (
    day: keyof typeof newEmployee.availability,
    available: boolean
  ) => {
    setNewEmployee((prev) => ({
      ...prev,
            ...
            <Table hover className="align-middle mb-0">
              ...
              <tbody>
                {employees.filter((emp) =>
                  showArchived
                    ? !emp.isActive || (emp as any).deletedAt
                    : emp.isActive && !(emp as any).deletedAt
                ).length === 0 ? (
                  <tr>
                    <td
                      colSpan={showArchived ? 4 : 9}
                        ...
                        <tr key={employee._id}>
                          ...
                          <td>
                            {employee.endContractReason ? (
                              <Badge bg="secondary">
                                {employee.endContractReason === "démission" &&
                                  "Démission"}
                                {employee.endContractReason ===
                                  "fin-periode-essai" &&
                                  "Fin de période d'essai"}
                                {employee.endContractReason === "rupture" &&
                                  "Rupture"}
                              </Badge>
                            ) : (
                              <small className="text-muted">
                          ...
                          <td>
                            <div style={{ minWidth: "120px" }}>
                              <ProgressBar
                                ...
                                variant={
                                  getOnboardingProgress(employee) === 100
                                    ? "success"
                                    : "warning"
                                }
                                style={{ height: "20px" }}
                              ...
                              {employee.isActive && (
                                <>
                                  ...
                                  <Button
                                    ...
                                    variant="outline-primary"
                                    onClick={() =>
                                      handleStartOnboarding(employee)
                                    }
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        socialSecurityNumber: e.target.value.replace(/\s/g, ""),
                      })
                    }
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        clockingCode: e.target.value.replace(/\D/g, ""),
                      })
                    }
                    placeholder="1234"
                    maxLength={4}
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        contractType: e.target.value as "CDI" | "CDD" | "Stage",
                      })
                    }
                  >
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        contractualHours: parseInt(e.target.value),
                      })
                    }
                  >
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        employeeRole: e.target.value as "Manager" | "Employé",
                      })
                    }
                  >
              ...
              {selectedEmployee.endDate && (
                <Alert variant="warning" className="mb-3">
                  ...
                  <div className="mt-2">
                    <small>
                      <strong>Date :</strong>{" "}
                      {new Date(selectedEmployee.endDate).toLocaleDateString(
                        "fr-FR"
                      )}
                      {selectedEmployee.endContractReason && (
                        <>
                          <br />
                          <strong>Motif :</strong>{" "}
                          {selectedEmployee.endContractReason === "démission" &&
                            "Démission"}
                          {selectedEmployee.endContractReason ===
                            "fin-periode-essai" && "Fin de période d'essai"}
                          {selectedEmployee.endContractReason === "rupture" &&
                            "Rupture"}
                        </>
                      )}
                    </small>
                    ...
                    <div key={day} className="mb-3 pb-3 border-bottom">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                        <Form.Check
                          ...
                          onChange={(e) =>
                            updateEditAvailability(day, e.target.checked)
                          }
                        />
                        {dayData?.available && (
                          <Button
                            ...
                            <Col md={2}>
                              {slots.length > 1 && (
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    removeEditTimeSlot(day, slotIndex)
                                  }
                                >
                                  <Icon icon="ri:delete-bin-line" />
                                </Button>
      ...
      >
            ...
            <>
              <Alert variant="info">
                ...
                <ul className="mb-0 mt-2">
                  <li>
                    Si la date est <strong>future</strong> : le contrat reste
                    actif jusqu'à cette date, puis sera archivé automatiquement
                  </li>
                  <li>
                    Si la date est <strong>passée ou aujourd'hui</strong> :
                ...
                >
                  {new Date(endContractDate) > new Date() ? (
                    <>
                      ...
                      <strong>
                        {new Date(endContractDate).toLocaleDateString("fr-FR")}
                      </strong>
                    </>
                  ) : (
                    <>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            disabled={saving || !endContractDate || !endContractReason}
          >
