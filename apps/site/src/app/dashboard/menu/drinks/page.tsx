...
export default function DrinksPage() {
  ...
  const handleSaveDrink = async () => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: editingDrink ? "Boisson mise à jour" : "Boisson créée",
      });
                ...
                {categories.map((category) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {
                          drinks.filter((d) => d.category._id === category._id)
                            .length
                        }
                      </Badge>
                    </div>
                      ...
                      <div className="d-flex align-items-center gap-2">
                        {canEdit && (
                          <div className="d-flex flex-column me-2">
                            <Button
                              ...
                              onClick={() =>
                                handleReorderCategory(category._id, "up")
                              }
                              disabled={index === 0}
                            >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleReorderCategory(category._id, "down")
                              }
                        ...
                        {canEdit && (
                          <Form.Check
                            ...
                            onChange={() =>
                              handleToggleShowOnSite(
                                category._id,
                                category.showOnSite !== false,
                              )
                            }
                            className="ms-3"
                          />
        ...
        <Modal.Body>
          <Form.Group className="mb-3">
            ...
            <Form.Select
              ...
              onChange={(e) =>
                setDrinkForm({ ...drinkForm, category: e.target.value })
              }
            >
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                setDrinkForm({ ...drinkForm, description: e.target.value })
              }
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                setDrinkForm({ ...drinkForm, recipe: e.target.value })
              }
              placeholder="• Étape 1&#10;• Étape 2&#10;• Étape 3..."
            />
