...
export const metadata: Metadata = {
  ...
  description:
    "Horaires du CoworKing Café by Anticafé à Strasbourg : ouvert 7j/7 pour travailler dans un espace coworking convivial. Fermetures exceptionnelles affichées.",
  ...
  openGraph: {
    title: "Horaires d'Ouverture CoworKing Café Strasbourg",
    description:
      "Consultez nos horaires d'ouverture : ouvert 7 jours sur 7 pour vous accueillir dans notre espace coworking chaleureux.",
