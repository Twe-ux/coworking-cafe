...
export const metadata: Metadata = {
  ...
  description:
    "Contactez CoworKing Café by Anticafé à Strasbourg : téléphone, email, adresse. Nous répondons à toutes vos questions sur le coworking et la location de salles.",
  ...
  openGraph: {
    ...
    description:
      "Nous contacter par téléphone, email ou venir nous voir directement. Réponse rapide à toutes vos questions sur le coworking.",
