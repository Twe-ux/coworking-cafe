import {
  ...
  transactionData,
  userData,
} from "../assets/dashboard/data/other";
import { sellersData } from "../assets/dashboard/data/product";
import { emailsData, socialGroupsData } from "../assets/dashboard/data/social";
import { todoData } from "../assets/dashboard/data/task";
import { notificationsData } from "../assets/dashboard/data/topbar";
import {
  AgentType,
  CustomerReviewsType,
  CustomerType,
