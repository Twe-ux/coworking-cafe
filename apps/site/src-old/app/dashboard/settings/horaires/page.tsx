...
export default function HorairesSettingsPage() {
  ...
  const [configuration, setConfiguration] = useState<HoursConfiguration | null>(
    null,
  );
  ...
  const removeExceptionalClosure = async (index: number) => {
    ...
    const updatedClosures = configuration.exceptionalClosures.filter(
      (_, i) => i !== index,
    );
      ...
      <Row>
        <Col lg={8}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted mb-4">
                Définissez les horaires d'ouverture pour chaque jour de la
                semaine.
              </p>
          ...
          <Card className="mt-3">
            <Card.Body>
              ...
              <p className="text-muted mb-4">
                Ajoutez les dates de fermeture exceptionnelle (jours fériés,
                congés, événements spéciaux). Une bannière s'affichera
                automatiquement sur le site pour annoncer les fermetures à
                venir.
              </p>
        ...
        <Col lg={4}>
          <Card className="bg-light">
            <Card.Body>
              <h5 className="mb-3">
                <i className="bi bi-info-circle text-primary me-2"></i>À propos
                des horaires
              </h5>
              <p>
                <strong>Horaires par défaut</strong>
                <br />
                Ces horaires s'appliquent à tous les espaces du coworking et
                sont affichés sur la page publique <code>/horaires</code>.
              </p>
              <hr />
              <p>
                <strong>Fermetures exceptionnelles</strong>
                <br />
                Lorsque vous ajoutez une fermeture, une bannière s'affiche
                automatiquement sur le site pour informer les visiteurs.
              </p>
              <hr />
              <p>
                <strong>Tranches horaires</strong>
                <br />
                Vous pouvez choisir entre une fermeture journée complète ou une
                fermeture partielle (par exemple: fermé de 14h à 16h). Décochez
                "Fermeture toute la journée" pour définir des horaires
                spécifiques.
              </p>
              <hr />
              <p>
                <strong>Bannière automatique</strong>
                <br />
                Les 3 prochaines fermetures sont affichées dans la bannière. La
                bannière peut être masquée par les visiteurs pour 24h.
              </p>
              <hr />
              <p>
                <strong>Impact sur les réservations</strong>
                <br />
                Les fermetures exceptionnelles empêchent automatiquement les
                réservations pour ces dates.
              </p>
              <hr />
              <p className="mb-0">
                <strong>Privatisations événementielles</strong>
                <br />
                Lorsqu'une réservation événementielle (privatisation totale) est
                confirmée, elle génère automatiquement une fermeture
                exceptionnelle sur le site selon les heures réservées. Si la
                privatisation est partielle, cette option peut être désactivée
                lors de la validation de la réservation.
              </p>
            </Card.Body>
          </Card>
        </Col>
