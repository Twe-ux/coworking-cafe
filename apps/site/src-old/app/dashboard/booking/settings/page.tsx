  ...
  const fetchSettings = async () => {
    try {
      ...
      if (data.success) {
        ...
        if (
          !loadedSettings.cancellationPolicyOpenSpace &&
          loadedSettings.cancellationPolicy
        ) {
          // Migrate old format to new format
          loadedSettings.cancellationPolicyOpenSpace =
            loadedSettings.cancellationPolicy;
          loadedSettings.cancellationPolicyMeetingRooms =
            loadedSettings.cancellationPolicy;
  ...
  const handleSave = async () => {
    try {
      ...
      if (data.success) {
        ...
        if (
          !savedSettings.cancellationPolicyOpenSpace &&
          savedSettings.cancellationPolicy
        ) {
          savedSettings.cancellationPolicyOpenSpace =
            savedSettings.cancellationPolicy;
          savedSettings.cancellationPolicyMeetingRooms =
            savedSettings.cancellationPolicy;
      ...
      <Row className="g-4">
        ...
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              <p className="text-muted small mb-3">
                Politique d'annulation pour les salles de réunion (étage,
                verrière)
              </p>
              <Table striped bordered hover size="sm">
                <thead>
              ...
              <Row>
                ...
                <Col md={4}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Text className="text-muted">
                      Types d'espaces nécessitant un accompte (Ctrl+clic pour
                      sélection multiple)
                    </Form.Text>
                  </Form.Group>
                </Col>
