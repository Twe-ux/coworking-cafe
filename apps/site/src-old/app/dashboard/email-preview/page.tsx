...
import {
  ...
  type BookingInitialEmailData,
} from "../../../lib/email/templates/clientBookingConfirmation";
...
export default function EmailPreviewPage() {
  ...
  const [bookingInitialData, setBookingInitialData] =
    useState<BookingInitialEmailData>({
      name: "Jean Dupont",
  ...
  const reservationRejectedData = {
    ...
    reason:
      "L'espace n'est pas disponible à cette date en raison de travaux de maintenance. Nous vous invitons à choisir une autre date.",
  };
  ...
  const passwordResetData = {
    ...
    resetUrl:
      "http://localhost:3000/auth/reset-password?token=sample-token-12345",
  };
  ...
  const getHtmlContent = () => {
    switch (emailType) {
      ...
      case "reservationCancelledByAdmin":
        return generateReservationCancelledEmail(
          reservationCancelledByAdminData,
        );
      ...
      >
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            ...
            <option value="reservationCancelledByAdmin">
              Annulée par admin
            </option>
