  ...
  return (
    <article>
      ...
      <div className="first__para">
        ...
        <p>
          Transfer details Choose the amount you want to send abroad, select how
          your receiver wants to get the money, and lastly, how you want to pay.
          You will always see our fees upfront, the final amount you will pay,
          and the exact amount your receiver will get.
        </p>
        <p>
          ...
          moon subway tile fam, cronut cray put a bird on it why is a common is
          kombucha gentrify available for your next project pok pok.
        </p>
      </div>
      <SlideUp>
        <blockquote>
          <b>
            “Bushwick post-ironic af fixie, wayfarers kombucha direct trade air
            plant meditation palo santo asymmetrical is salvia blue bottle. 3
            wolf moon subway tile in the next project in the last season fam.”
          </b>
          <p>
            <span />
            John Smith
