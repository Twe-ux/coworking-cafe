...
const LayoutProvider = ({ children }: ChildrenType) => {
  ...
  const INIT_STATE: LayoutState = {
    theme: queryParams["layout_theme"]
      ? (queryParams["layout_theme"] as ThemeType)
      : getPreferredTheme(),
    topbarTheme: queryParams["topbar_theme"]
      ? (queryParams["topbar_theme"] as ThemeType)
      : "light",
    menu: {
      theme: queryParams["menu_theme"]
        ? (queryParams["menu_theme"] as MenuType["theme"])
        : "light",
      size: queryParams["menu_size"]
        ? (queryParams["menu_size"] as MenuType["size"])
        : "default",
    },
  };
