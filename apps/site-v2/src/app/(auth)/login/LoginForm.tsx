...
export function LoginForm() {
  ...
  const forgotLink = (
    <Link href="/reset" className="font-mono"
          ...
          <div className="flex flex-col md:overflow-y-auto md:bg-white md:px-[60px] md:py-[44px]">
            ...
            <div className="hidden md:flex justify-between items-center mb-[40px]">
              <div className="font-mono"
                style={{ fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--gry)" }}>
                Français · FR
              </div>
            ...
            <div className="md:hidden mb-6">
              <div className="font-mono"
                style={{ fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--main)", marginBottom: 8 }}>
                — Content de vous revoir —
              </div>
              <h1 className="font-serif"
                style={{ fontSize: 34, fontWeight: 400, lineHeight: 1.05, letterSpacing: "-0.02em", color: "var(--body)", margin: 0 }}>
            ...
            <div className="hidden md:block mb-6">
              ...
              <h1 className="font-serif"
                style={{ fontSize: 44, fontWeight: 400, lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--body)", margin: 0 }}>
                Connectez-vous à votre <em style={{ color: "var(--main)", fontStyle: "italic" }}>espace</em>
              </h1>
              <p className="font-sans"
                style={{ fontSize: 14, color: "var(--gry)", marginTop: 14, lineHeight: 1.55 }}>
                Accédez à vos réservations, votre fidélité et vos factures en un clin d&apos;œil.
              </p>
            </div>

            {/* Social buttons — mobile: vertical, desktop: 2 cols */}
            <div className="flex flex-col gap-2.5 md:grid md:gap-2.5 mb-4" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <div className="md:hidden text-center text-sm mt-4" style={{ color: "var(--gry)" }}>
