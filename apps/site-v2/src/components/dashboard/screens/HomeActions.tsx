...
import type { DashboardStats, DashboardSection } from "@/types/dashboard"
...
export function HomeActions({ stats, onNavigate }: HomeActionsProps) {
  const progressPct = Math.min((stats.memberPoints / stats.nextReward) * 100, 100)
    ...
    <div style={{ paddingBottom: 24 }}>
      ...
      <div style={{ padding: '16px 16px 0', marginTop: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          <div
            style={{ background: 'var(--btn)', borderRadius: 18, padding: 18, cursor: 'pointer' }}
            onClick={() => { window.location.href = '/booking' }}
            role="button"
            tabIndex={0}
            onKeyDown={(e) => { if (e.key === 'Enter') window.location.href = '/booking' }}
          >
            ...
            <div className="font-serif" style={{ fontSize: 17, color: 'var(--body)', marginTop: 10 }}>
          ...
          <div
            style={{ background: '#fff', border: '1px solid var(--line)', borderRadius: 18, padding: 18, cursor: 'pointer' }}
      ...
      <div style={{ margin: '12px 16px 0', background: 'var(--body)', borderRadius: 22, padding: 18, position: 'relative', overflow: 'hidden' }}>
        {/* Overlay décoratif */}
        ...
        <div style={{ position: 'relative' }}>
          ...
          {/* Points */}
          <div className="font-serif" style={{ fontSize: 38, color: 'var(--btn)', lineHeight: 1, marginTop: 8 }}>
            {stats.memberPoints}
          </div>
      ...
      <div style={{ marginTop: 12, paddingBottom: 4 }}>
        <div style={{ padding: '0 16px', overflowX: 'auto', scrollbarWidth: 'none' as const }}>
          <div style={{ display: 'flex', gap: 10, width: 'fit-content', paddingBottom: 4 }}>
            ...
            <div style={{ flexShrink: 0, width: 200, borderRadius: 18, padding: 16, background: '#5A938B' }}>
              <Icon name="tag" size={20} stroke="#fff" />
              <div className="font-serif" style={{ fontSize: 18, color: '#fff', marginTop: 10, lineHeight: 1.1 }}>
