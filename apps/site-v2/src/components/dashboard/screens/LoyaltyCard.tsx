    ...
    >
      ...
      <div
        style={{
          ...
          height: 160,
          borderRadius: "50%",
          background: "radial-gradient(circle at center, rgba(65,121,114,0.25), transparent 70%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ position: "relative" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span
            className="font-mono"
            style={{ fontSize: 11, color: "rgba(255,255,255,0.6)", textTransform: "uppercase", letterSpacing: "0.1em" }}
          >
            Programme fidélité
          </span>
        </div>
