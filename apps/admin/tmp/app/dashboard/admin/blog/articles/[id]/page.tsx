...
export default function EditArticlePage() {
  ...
  const fetchCategories = useCallback(async () => {
    try {
      ...
      const data = await response.json()
      if (data.success) {
        // Transformer les catégories pour avoir un champ id
  ...
  }, [params?.id]) // Ne recharger que quand l'ID change
  ...
  const handleSubmit = async (data: UpdateArticleInput, publish = false) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: 'Erreur',
          description: result.message || result.error || 'Impossible de mettre à jour l\'article',
          variant: 'destructive',
        })
      }
    } catch (error) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: 'Erreur',
          description: result.message || result.error || 'Impossible de supprimer l\'article',
          variant: 'destructive',
        })
      }
    } catch (error) {
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Cette action est irréversible. L'article "{article?.title}" et tous ses commentaires seront définitivement supprimés.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
