...
/**
 * HR Management content component (uses useSearchParams and useSession)
 * This component is client-only to avoid SessionProvider SSR issues
 */
export function HRManagementContent() {
  const {
    // Data
    session,
    activeTab,
