  ...
  return (
    <div style={{ pageBreakBefore: "always" }}>
      ...
      <p style={{ marginBottom: "10px", fontStyle: "italic" }}>
        La durée mensuelle de travail a été divisée par 4,33 semaines en moyenne
        par mois pour obtenir la référence horaire hebdomadaire servant à
        définir le volant des plages de planification possible.
      </p>
  ...
  return (
    <ArticleSection title="Article 5 - Répartition de la durée du travail">
      <p style={{ marginBottom: "12px" }}>
        ...
        ci-après. Cette répartition est effectuée dans le respect des plages de
        planification possible visées a l&apos;article 4.
      </p>
      <div style={{ marginBottom: "10px" }}>
        <DistributionTable employee={employee} />
      </div>
      <p style={{ marginBottom: "10px" }}>
        En ce qui concerne les jours de repos hebdomadaires, il a été convenu en
        accord avec le Salarie et conformément aux dispositions conventionnelles
        que les 2 jours de repos hebdomadaires sont fixés contractuellement dans
        le tableau de répartition ci-dessus.
      </p>
    </ArticleSection>
  );
}
  ...
  return (
    <ArticleSection title="Article 6 - Heures complémentaires">
      <p style={{ marginBottom: "10px" }}>
        ...
        Salarié pourra être amené à effectuer des heures complémentaires, dans
        la limite du tiers de la durée initiale du contrat par semaine.
      </p>
      <p style={{ marginBottom: "10px" }}>
        Les heures complémentaires effectuées en-deca du 1/10 de la durée
        initialement fixée au contrat seront majorées a <strong>10%</strong>.
      </p>
      <p style={{ marginBottom: "10px" }}>
        Les heures complémentaires effectuées au-delà du 1/10 de la durée
        initialement fixée au contrat seront majorées a <strong>25%</strong>.
      </p>
    </ArticleSection>
  );
}
...
export function Article7({
  ...
  const calculatedSalary =
    hourlyRate > 0 && monthlySalary !== "0.00"
      ? monthlySalary
