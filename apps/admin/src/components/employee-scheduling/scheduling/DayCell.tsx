...
export function DayCell({
  ...
  const isEmployeeUnavailable = (
    ...
    return unavailabilities.find((unavail) => {
      if (
        typeof unavail.employeeId === "object" &&
        unavail.employeeId !== null
      ) {
        const empId =
          (unavail.employeeId as any).id || (unavail.employeeId as any)._id;
                  ...
                  morningShifts.map((shift) => {
                    ...
                    return (
                      <ShiftBadge
                        ...
                        employee={employee}
                        colorOverride={
                          shiftWithMeta._unavailabilityRequested
                            ? "#f97316"
                            : undefined
                        }
                      />
