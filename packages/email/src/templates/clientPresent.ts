...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #fff;">
  <div class="email-container" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
    ...
    <div class="email-header" style="background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: white; padding: 40px 24px; text-align: center;">
      <h1 style="margin: 0 0 12px 0; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">✅ Merci pour votre venue !</h1>
      <p style="margin: 0; font-size: 17px; opacity: 0.95; font-weight: 500;">Empreinte bancaire libérée</p>
    </div>

    <!-- Contenu -->
    <div class="email-content" style="padding: 36px 24px; line-height: 1.7; color: #1f2937;">
      <p style="margin: 0 0 16px 0; font-size: 16px;">Bonjour <strong style="color: #10B981;">${data.name}</strong>,</p>

      <p style="margin: 0 0 24px 0; font-size: 16px;">Merci d'être venu(e) au <strong>CoworKing Café by Anticafé</strong> aujourd'hui !</p>
      ...
      <p style="margin: 0 0 24px 0; font-size: 16px;">Votre <strong>empreinte bancaire a été libérée</strong>. Aucun montant ne sera débité de votre carte.</p>

      <!-- Détails de la réservation -->
      <div class="details-box" style="background: #f9fafb; padding: 24px; border-radius: 12px; margin: 28px 0; border: 1px solid #10B981;">
        <h3 style="margin: 0 0 20px 0; color: #10B981; font-size: 19px; font-weight: 700; letter-spacing: -0.3px;">📋 Récapitulatif de votre visite</h3>
      ...
      <div style="background: #f0fdf4; border-left: 4px solid #10B981; padding: 20px; border-radius: 8px; margin: 28px 0;">
        <p style="margin: 0 0 12px 0; font-weight: 700; color: #065f46 !important; font-size: 16px;">💬 Votre avis compte !</p>
        <p style="margin: 0; font-size: 15px; color: #065f46 !important;">
          N'hésitez pas à nous faire part de votre expérience. Votre retour nous aide à améliorer nos services.
        </p>
      </div>
